...
$query = "CREATE TEMPORARY TABLE query_table_2 AS
        	 				 ...
        	 				 LEFT JOIN query_table AS prevdata ON currdata.data_3 = prevdata.data_1
									 WHERE (currdata.LSN IN ('lsmsc1','lsmsc2','lsmsc3','lshss686','lshss689')) AND (prevdata.data_1 IS NOT NULL) AND currdata.timestamp = ( SELECT MAX( timestamp) FROM query_table ) 
